...
[![Version](https://img.shields.io/badge/dynamic/json?url=https://cnb-registry-api.herokuapp.com/api/v1/buildpacks/fagiani/static&label=Version&query=$.latest.version)](https://github.com/fagiani/static-buildpack)

This is a [Cloud Native Buildpack](https://buildpacks.io/) for handling static sites and single page web apps.

This buildpack is based on the [heroku-buildpack-static](https://github.com/heroku/heroku-buildpack-static)
...
Set the app to use this buildpack: `$ pack build --buildpacks fagiani/static my-app`
